...
const About = () => {
  return (
    <section id="about" className="px-4 bg-gray-100 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto text-center py-16">  {/* Adjusted spacing */}
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
          Why Choose <span className="text-blue-600 dark:text-blue-400">LuxuryEstates</span>?
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center p-6 rounded-lg bg-white dark:bg-gray-800 shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Premium Properties</h3>
          ...
          <div className="text-center p-6 rounded-lg bg-white dark:bg-gray-800 shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Expert Agents</h3>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="text-center p-6 rounded-lg bg-white dark:bg-gray-800 shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Secure & Transparent Deals</h3>
            <p className="text-gray-600 dark:text-gray-300">
